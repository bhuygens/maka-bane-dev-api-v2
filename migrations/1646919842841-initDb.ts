...
export class initDb1646919842841 implements MigrationInterface {
    name = 'initDb1646919842841'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "blog_articles" ("id" SERIAL NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "title" character varying(100) NOT NULL, "content" text NOT NULL, "is_best_article" boolean DEFAULT false, "images_url" text NOT NULL, "tags" text array, "content_header" text, "category_id" integer, CONSTRAINT "PK_7e7a57a75e6fdde30b6f368bb76" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "formations" ("id" SERIAL NOT NULL, "name" character varying(200) NOT NULL, "description" text NOT NULL, "benefit" character varying(2000) NOT NULL, "duration" integer NOT NULL, "images_url" character varying(1000) NOT NULL, "tags" character varying(1000) NOT NULL, "vat_price" numeric(2) NOT NULL DEFAULT '0', "vat_amount" numeric(2) NOT NULL DEFAULT '0', "duration_text" character varying(1000), "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_e071aaba3322392364953ba5c95" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "formations_availabilities" ("id" SERIAL NOT NULL, "formation_id" integer, "place" integer NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "left_places" integer NOT NULL, "progenda_link" character varying(500), "hour" text, CONSTRAINT "PK_247ad422be6eecac0d11057756c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_stock" ("id" SERIAL NOT NULL, "product_id" integer NOT NULL, "quantity" integer NOT NULL, "date" TIMESTAMP WITH TIME ZONE, "seller" text, "orderId" text, CONSTRAINT "PK_557112c9955555e7d08fa913f3f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "reviews" ("id" SERIAL NOT NULL, "client_id" integer NOT NULL, "product_id" integer, "care_id" integer, "formation_id" integer, "note" numeric(2) NOT NULL DEFAULT '0', "date" TIMESTAMP WITH TIME ZONE NOT NULL, "description" character varying(300) NOT NULL, CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cares" ("id" SERIAL NOT NULL, "name" character varying(200) NOT NULL, "note" integer, "description" character varying(1000) NOT NULL, "benefit" character varying(2000) NOT NULL, "duration" integer NOT NULL, "images_url" character varying array NOT NULL, "tags" character varying(1000) array NOT NULL, "vat_price" numeric(12,2) NOT NULL, "vat_amount" numeric(12,2) DEFAULT '0.2', "duration_text" character varying(1000) NOT NULL, CONSTRAINT "PK_4d91b850b958c51bbc3dde736cd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cares_availabilities" ("id" SERIAL NOT NULL, "care_id" integer, "place" integer NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "left_places" integer NOT NULL, "progenda_link" character varying(500), CONSTRAINT "PK_6d1d8efc7ac8e3c60305f7d79c1" PRIMARY KEY ("id"))`);
